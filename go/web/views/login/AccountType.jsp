                    ...
                    <el-form :inline="true" :model="formInline" class="el-form--inline">
                        ...
                        <el-col :span="8">
                            <el-form-item label="类型名称">
                                <el-input v-model="formInline.name" placeholder="类型名称"></el-input>
                            </el-form-item>
                        </el-col>
    ...
    var app = new Vue({
        ...
        methods: {
            ...
            query: function() {
                ...
                // 开始查询
                this.$http.post('o/accountType/listByPage', params).then(function (res) {
            ...
            del: function () {
                ...
                this.$http.post("o/accountType/del/" + this.currentRow.id)
                    .then(function (res) {
                        console.log(res);
                        try {
                            if (res.body.success) {

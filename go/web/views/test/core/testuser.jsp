            ...
            <el-table
                ...
                <el-table-column
                    ...
                    <template slot-scope="scope">
                            <el-button @click="openuserSonApp(scope.row)" type="text" size="small">查看test</el-button>
                    </template>
                </el-table-column>
...
<script type="text/javascript">
    ...
    var app = new Vue({
        ...
        methods: {
            openuserSonApp: function (obj) {
                this.currentRow = obj;
                if (this.currentRow == null || !this.currentRow.id == null) {
                    this.msgs().open3("未选中")
                    return;
                } else {
                    userSonApp.tableName = this.currentRow.name || 'test'; // 将name作为 子窗体的标题
                    userSonApp.formInline.userId = obj.id;
                    userSonApp.prBean = obj;
                    userSonApp.query();
                    userSonApp.app = true;
                }
            },
    ...
    var userSonApp = new Vue({
        ...
        methods: {
            ...
            query: function () {
                ...
                params.param = this.formInline;
                // 开始查询
                this.$http.post('o/userSon/listByPage', params).then(function (res) {
                    this.tableData = res.body.data;
                    console.log(res);
                })
            },

        ...
        <el-dialog title="${table.content}"
            ...
            <div style="text-align: left; margin: 0">
                ...
                ,
                    ...
                    <#list fields as field>
                        <#if field.javaName != 'id' && field.javaName != 'createDate' && field.javaName != 'createBy' && field.javaName != 'updateBy' && field.javaName != 'updateDate'>
                    <el-form-item label="${field.content}" prop="${field.javaName}">
                        <el-input v-model="ruleForm.${field.javaName}"></el-input>
                    </el-form-item>
                        </#if>
                    </#list>
                    <el-form-item>
                    ...
                    <el-form :inline="true" :model="formInline" class="el-form--inline"  label-width="100px" label-position="right">
                        ...
                        <el-col :span="12">
                            <el-form-item label="${field.content}">
                                <el-input v-model="formInline.${field.javaName}" placeholder="${field.content}"></el-input>
                            </el-form-item>
                        </el-col>
                            </#if>
                        </#list>
            ...
            <el-table
                ...
                <el-table-column type="expand">
                    <template slot-scope="props">
                        ...
                        <#list fields as field>
                            <#if field.javaName != 'id' && field.javaName != 'createBy' && field.javaName != 'updateBy'>
                                <el-form-item label="${field.content}">
    ...
    var app = new Vue({
        ...
        methods: {
            ...
            del: function () {
                ...
                this.$http.post("o/${table.name}/del/" + this.currentRow.id)
                    .then(function (res) {
                        console.log(res);
                        try {
                            if (res.body.success) {

    ...
    <div>
        ...
        <el-dialog title="唯一约束"
            ...
            <div style="text-align: left; margin: 0">
                ...
                ,
                unName: [
                    {required: true, message: '请输入唯一约束的昵称', trigger: 'change'}
                ]
                ,
            }" ref="ruleForm"
                    ...
                    <el-form-item label="" prop="fieldId">
                        <el-input v-model="ruleForm.fieldId"></el-input>
                    </el-form-item>
                    <el-form-item label="唯一约束的昵称" prop="unName">
            ...
            <el-collapse v-model="activeName" @change="handleChange">
                <el-collapse-item name="1">
                    ...
                    <el-form :inline="true" :model="formInline" class="el-form--inline"  label-width="100px" label-position="right">
                        ...
                        <el-col :span="12">
                            <el-form-item label="">
                                <el-input v-model="formInline.tableId" placeholder=""></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                            <el-form-item label="">
                                <el-input v-model="formInline.fieldId" placeholder=""></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                            <el-form-item label="唯一约束的昵称">
                                <el-input v-model="formInline.unName" placeholder="唯一约束的昵称"></el-input>
                            </el-form-item>
                        </el-col>
    ...
    var app = new Vue({
        ...
        methods: {
            ...
            query: function() {
                ...
                // 开始查询
                this.$http.post('o/tableUn/listByPage', params).then(function (res) {
            ...
            del: function () {
                ...
                this.$http.post("o/tableUn/del/" + this.currentRow.id)
                    .then(function (res) {
                        console.log(res);
                        try {
                            if (res.body.success) {

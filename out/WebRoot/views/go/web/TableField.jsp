...
<!-- 一个 单页的 单对单 go_pr_table_field -->
<html>
<head>
    <title>go_pr_table_field</title>
...
<div id="app" style="display: none">
    ...
    <div>
        ...
        <!-- 编辑 添加部分 -->
        <el-dialog title="go_pr_table_field"
    ...
    var app = new Vue({
        ...
        methods: {
            ...
            query: function() {
                ...
                // 开始查询
                this.$http.post('o/tableField/listByPage', params).then(function (res) {
            ...
            del: function () {
                ...
                this.$http.post("o/tableField/del/" + this.currentRow.id)
                    .then(function (res) {
                        console.log(res);
                        try {
                            if (res.body.success) {
